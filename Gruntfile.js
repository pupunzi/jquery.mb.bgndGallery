/*___________________________________________________________________________________________________________________________________________________
 ...
 _ last modified: 27/06/15 12.59                                                                                                                    _
 _                                                                                                                                                  _
...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		concat: {
			...
			dist   : {
				src : [ 'src/jquery.mb.bgndGallery.src.js','src/jquery.mb.bgndGallery.effects.src.js', 'src/dep/*.js'],
		...
		bump: {
			options: {
				...
				push              : true,
				pushTo            : 'https://github.com/pupunzi/jquery.mb.bgndGallery.git',
